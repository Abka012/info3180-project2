      ...
      <form @submit.prevent="handleSubmit">
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input id="age" v-model.number="form.age" type="number" min="18" max="120" required />
            <span class="error" v-if="errors.age">{{ errors.age[0] }}</span>
          </div>
        </div>
        
        <div class="form-group">
          <label for="bio">About Me</label>
          <textarea id="bio" v-model="form.bio" rows="4" placeholder="Tell us about yourself..."></textarea>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            <label for="geo_preferences">Location Preference</label>
            <select id="geo_preferences" v-model="form.geo_preferences">
        ...
        <div class="form-group">
          <label for="interests">Interests (minimum 3, comma separated) *</label>
          <input id="interests" v-model="form.interests" type="text" placeholder="e.g., Reading, Hiking, Cooking, Music" required />
          <span class="error" v-if="errors.interests">{{ errors.interests[0] }}</span>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input id="occupation" v-model="form.occupation" type="text" placeholder="Your job" />
          </div>
        </div>
        ...
        <div class="form-actions">
          <button type="button" class="btn-secondary" @click="router.push('/profile')">Cancel</button>
...
const loadProfile = async () => {
  try {
    ...
    form.geo_preferences = data.geo_preferences || 'anywhere';
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (error.response?.data?.errors) {
      ...
      errors.value = { general: ['Failed to save profile. Please try again.'] };
    }
  } finally {
    loading.value = false;
  }
